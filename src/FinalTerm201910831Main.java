...
public class FinalTerm201910831Main {
    public static void main(String[] args) {
        ...
        // Declare the array of Separators and Stopwords
        String[] separator = {" ", "\t", "\n", ",", ".", ":", "(", ")", "[", "]", "{", "}"};
        String[] stopword = {"a", "the", "The", "to", "as", "of", "on", "with", "by", "for", "in"};

        // Print the menu of program
        System.out.print("Please Enter the number of times you want: ");
        // Typing the number of Input
        Scanner scanner = new Scanner(System.in);
        int num = scanner.nextInt();

        // Declare the object of WordCount Class
        WordCount wordCount = new WordCount(str, separator, stopword);
        // Count the String without Stopwords
        wordCount.CountingWords();
        // Print the word
        wordCount.ShowWords(num);
    }
}
